...
class ResultsPage extends React.Component {
        ...
        axios.get(this.props.url + "/uzi/" + this.props.props + "/?format=json")
            .then((response) => {
                ...
                this.setState({
                    ...
                    date_of_birth: new Date(response.data.info.patient.date_of_birth),
    ...
    // const response = await  axios.post(this.props.url + "/uzi/" + this.props.props + "/report/", {
    //     responseType: 'blob',
    // });
    ...
    // link.click();
    axios({
        url: this.props.url + "/uzi/" + this.props.props + "/report/",
        method: 'POST',
        responseType: 'blob', 
    })
    .then(response => {
        ...
        console.log(blob)
        link.download = "Отчет_"+(new Date).toLocaleDateString()+"_"+(new Date).toLocaleTimeString()+".xlsx";
        link.click();
                ...
                <Box component={""} sx={{
                    ...
                    <Grid component={""} container direction={'column'} alignContent={'center'} justifyContent={'center'} sx={{marginBlock: -1}}>
                        <Grid component={""} item>
                            ...
                            <Stack className={'third-step'} direction="row" sx={{paddingTop: 1, paddingBottom: 3}}>
                                <h3 style={{
                                    color: 'dimgray',
                                    fontSize: 20,
                                    fontFamily: "Roboto",
                                ...
                                <h3>  {this.state.date_of_birth.toLocaleDateString()}</h3>
                            </Stack>
                                        ...
                                        <Box component={""} sx={{
                                            ...
                                            {/* {({loading}) =>
                                                    ...
                                                    <Button sx={{
                                                        ...
                                                        '&:hover': {},
                                                        fontFamily: 'Roboto'
                                                    }} className={'ninth-step'} variant={'outlined'} onClick={this.handleDownload}>Скачать заключение</Button>
                                                    {/* )} */}
                                        </Box>
                                        <Box component={""} sx={{
