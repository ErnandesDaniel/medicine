...
class NewPatientPage extends React.Component {
    ...
    handleResponse = () => {
        ...
        formData.append("patient.address", this.state.address);
        formData.append("patient.date_of_birth", new Date(this.state.date_of_birth).getUTCFullYear() + "-"+ new Date(this.state.date_of_birth).getUTCMonth()+"-"+ new Date(this.state.date_of_birth).getUTCDate());
                ...
                <Box component={""} sx={{
                    ...
                    <Grid component={""} container spacing={1} >
                        <Grid component={""} item xs sx={{display: 'flex', flexDirection:'column', justifyContent: 'center', alignContent: 'center'}}>
                            ...
                            <Box component={""} sx={{width: 500, borderRadius: 3,  paddingBottom: 3}}>
                                   <FormControl variant={'outlined'} fullWidth>
                                   <InputLabel required={true} shrink sx={{marginBlockEnd: 10, paddingBottom: 5}}>
                                        Дата рождения
                                    </InputLabel>
                                       <LocalizationProvider adapterLocale={'ru'} dateAdapter={AdapterDayjs}>
                                           <DatePicker
                                            ...
                                            onChange={(newValue) => {
                                                               this.setState({date_of_birth: newValue})
                                                  }}
                                                renderInput={(params) => <TextFieldWrapper helperText="Введите дату рождения пациента" {...params}
                                                    //InputLabelProps={{shrink: true, marginBlockEnd: 5}}
                                                    />}
                                            />
                            ...
                            <Box component={""} sx={{width: 500, paddingBottom: 3}}>
                                <FormControl fullWidth>
                                    ...
                                    <TextFieldWrapper
                                        ...
                                        error={!this.state.addressEntered && this.state.address.length !== 0}
                                        variant='outlined'
                                        helperText="Введите адрес пациента"
                                        sx={{marginBlockStart: 1}}
                                    >
                                    </TextFieldWrapper>
                                </FormControl>
