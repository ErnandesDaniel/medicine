...
import {Box, Button, Card, Chip, FormControl, MenuItem, Slider, TextField} from "@mui/material";
            ...
            if (props.img !== "" && props.img !== null) {
                if (props.img.split('.')[1] === 'tiff' || props.img.split('.')[1] === 'tif') {
                    ...
                    while (i <= props.image_count){
                        tmp_ar.push({type: 'image', url: 'http://msa.mephi.ru' + props.slide_template[0]+'/'+ props.slide_template[1]+i+props.slide_template[2]})
                        i++
                    }
                    // const xhr = new XMLHttpRequest();
